...
abstract class AbstractComparison extends AbstractBase implements ConditionInterface
{
    ...
    {
        $objBuilder->addWhereItem($this->objQueryNode->getColumnAlias($objBuilder) . $this->strOperator . Node\AbstractBase::getValue($this->mixOperand,
                $objBuilder));
    }
